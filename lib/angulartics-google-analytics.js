...
.config(['$analyticsProvider', function ($analyticsProvider) {
  ...
  $analyticsProvider.registerTrackTiming(function (properties) {
    ...
    if (window.ga) {
      ...
      ga('send', 'timing', properties.category, properties.variable, properties.value, properties.label, eventOptions);
      angular.forEach($analyticsProvider.settings.ga.additionalAccountNames, function (accountName){
        ga(accountName +'.send', 'timing', properties.category, properties.variable, properties.value, properties.label, eventOptions);
      });
    }

    else if (window._gaq) {
      _gaq.push(['_trackTiming', properties.category, properties.variable, properties.value, properties.label, properties.sampleRate]);
    }
  });
